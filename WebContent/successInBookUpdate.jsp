...
<title>Book Updated Successfully</title>
...
.container1 { position:center; width:700px; background: linear-gradient(#660066, #FF66FF);  overflow:auto;
               padding:3px; gradient; border-radius:15px; border:3px solid #000000;opacity:0.95;}
...
%>
 ...
 <h2 style="margin-left:150px">4. BookList Updated Successfully !! </h2>
</div><br>
