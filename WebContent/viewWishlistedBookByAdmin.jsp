...
.container2 { position:center; width:1200px; background: linear-gradient(#ff4d4d,#ffb3b3);  overflow:auto;
...
<div class="container2" style="margin-left:50px;">
   <h2 style="margin-left:350px">5. View Wishlisted Book List :</h2>
      <table id="wishListTable" class="CSSTableGenerator">
			<tr>
				<th>WishListed By</th>
				<th>Book Name</th>
				<th>Book Author</th>
            ...
            <s:iterator value="wishBookList" var="wishList">
            <tr>
                    <td align="center"><s:property value="requested_by_id_foreign"/></td>
					<td align="center"><s:property value="wishlisted_book" /></td>
					<td align="center"><s:property value="wishlistedbook_author" /></td>
					<td align="center"><s:property value="branch_type_foreign" /></td>
					<td align="center"><s:property value="semester" /></td>
					<td align="center"><s:property value="wishlisted_book_publisher" /></td>
           </tr>
	        </s:iterator>
 </table>
 </div><br></br>	
