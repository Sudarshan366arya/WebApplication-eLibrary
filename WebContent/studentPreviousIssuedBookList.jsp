...
<title>Issued Books And Due</title>
<style type="text/css">
body {
...
<div class="container2" style="margin-left:80px;">
    <h2 style="margin-left:250px">3.LIST OF PREVIOUSLY ISSUED BOOKS AND DUES :</h2>
    <table id="issuedBook" class="CSSTableGenerator">
		<tr>
		    <th>Book ID</th>
			<th>Book Name</th>
			<th>Book Author</th>
		...
		<s:iterator value="viewBookReturnList" var="avail">
			<tr>
				...
				<td align="center"><s:property value="issued_date"/></td>
				<td align="center"><s:property value="return_date"/></td>
				<td align="center"><s:property value="actual_day_of_return"/></td>
				<td align="center"><s:property value="due_balance"/></td>			
			</tr>
		</s:iterator>
	</table>
</div>
