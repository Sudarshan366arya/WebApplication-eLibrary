...
<div class="container2" style="margin-left:50px;">
		<h2 style="margin-left:300px">2. Approve Request Of These Book Issue :</h2>
		<table id="approveBookTable" class="CSSTableGenerator" >
			<tr>
				<th>Student Id</th>
				<th>Roll</th>
				<th>Name</th>
			...
			<s:iterator value="issuingBookList" var="issueList">
				<tr>
					<td align="center"><s:property value="student_id" /></td>
					<td align="center"><s:property value="roll" /></td>
					<td align="center"><s:property value="name" /></td>
					<td align="center"><s:property value="branch_name" /></td>
					<td align="center"><s:property value="batch" /></td>
					<td align="center"><s:property value="number_of_books_issued" /></td>
					...
					<td align="center"><a class="circle1"
						href="approveThisBookIssue?admin_id=<s:property value="admin_id"/>&booking_id=<s:property value="booking_id"/>">approve ?</a></td>
					<td align="center"><a class="circle2"
						href="rejectThisBookIssue?admin_id=<s:property value="admin_id"/>&booking_id=<s:property value="booking_id"/>">reject ?</a></td>
				</tr>
			</s:iterator>
		</table>
</div>
