...
<title>Book Return Request</title>
<style type="text/css">
  body {
...
<div class="container2" style="margin-left:50px;">
   <h2 style="margin-left:300px">3. Approve Book Returning Request : </h2>
      <table id="approveReturnBookTable" class="CSSTableGenerator">
            ...
            <tr>
					...
					<td align="center"><a class="circle1"
						href="approveThisBookReturn?admin_id=<s:property value="admin_id"/>&booking_id=<s:property value="booking_id"/>">approve ?</a></td>
           </tr>
	        </s:iterator>
 </table>
 </div><br>	
