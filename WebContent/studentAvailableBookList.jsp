...
.container2 { position:center; width:1100px;  background: linear-gradient(#ff4d4d,#ffb3b3);  overflow:auto;
...
<div class="container2" style="margin-left:100px;">
 <h2 style="margin-left:150px">1. List Of Available Books in Library</h2>
	<table id="availableBook" class="CSSTableGenerator">
		<tr>
			<th>Book Name</th>
			<th>Book Author</th>
			<th>Description </th>
		...
		<s:iterator value="availList" var="avail">
			<tr>
				...
				<td align="center"> <a class="circle1" href="student_issue_book?student_id=<s:property value="student_id"/>&book_id=<s:property value="book_id"/>">ISSUE BOOK ?</a></td>
			</tr>
		</s:iterator>
	</table>
	</div><br></br>
	<div class="container1" style="margin-left:300px;">
	<h2 style="margin-left:60px">2. Issued Books And Due : <a class="circle3" href="issuedBooks?student_id=<s:property value="student_id"/>">CLICK</a></h2>
