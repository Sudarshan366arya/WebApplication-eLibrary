...
<div class="container2" style="margin-left:80px;">
 <h2 style="margin-left:250px">2.LIST OF ISSUED BOOKS :</h2>
    <table id="issuedBook" class="CSSTableGenerator">
		...
		<s:iterator value="viewBookList" var="avail">
			<tr>
				...
				<td align="center"><a class="circle1" href="return_issued_book?student_id=<s:property value="student_id"/>&booking_id=<s:property value="booking_id"/>">Return now ?</a></td>
			</tr>
		</s:iterator>
	</table>
	</div>
